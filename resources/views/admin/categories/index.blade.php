            ...
            var table = $('#my-Table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return `<img src="{{ Storage::url('${data}') }}" style="width: 60px; height: 80px; object-fit: cover">`; 
                            //  width= '60' height='60' 
                        }
                    },
                    {
                ...
                buttons: [

                    {
                        extend: 'print',
                        exportOptions: {
                            columns: ':visible :not(.not-export)' //khi print sẽ trừ element có class = not-export
                        }
                    },
                    {
                        extend: 'pdf',
